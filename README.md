...
<table>
  <tr>
    <td valign="top" width="50%">
      <img src="https://github.com/oraphalopes/ReinforcementLearning/blob/main/ReinforcementLearning_QuantumFinance/rede%20neural_mercado%20financeiro.png?raw=true" width="100%">
    </td>
    <td valign="top" width="50%">
      ...
      - <strong>Maximização do Retorno Ajustado ao Risco (Alpha)</strong><br>
      - <strong>Proteção de Capital (Risk Management)</strong><br>
      - <strong>Detecção de Momentum</strong><br><br>
